...
<div class="detailsform">
    <form action="{{route('storecustomer')}}" method="POST" autocomplete="off">
        ...
        @if(count($plans) === 0)
            <br>
            <p style="margin-left: 24px; color: #aaa; display:inline; font-size: 1em;">Before adding a Customer, please</p>
            <a style="text-decoration: none; color: #d00000; font-weight: bold; display:inline-block; font-size: 1em;" href="{{ route('planform') }}">Create a Plan</a>
